...
<body style="bg-color:white">
	<div class="doctors">
      <h3 class="text-center" style="background-color:#272327;color: #fff;">Doctors of Hyderabad</h3>
                            <div class="col-md-12" style="">
                                 <div class="col-md-3">
                                      <img src="img/doctor1.jpg" alt="" class="img-responsive" style="width: 220px;height: 220px">
                                  </div> <br>
                                  <div class="col-md-3" >                                     
                                     <h3 style="color:#0616BC;">Dr. Ravi Kumar</h3>
                                              ...
                                              <div class="panel panel-default">
                                                ...
                                                <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                                                  <div class="panel-body">
                                                        MBBS, BCS (Health),Obstetrics Specialist
                                                  </div>
                                                </div>
                                              </div>                                           
                                              <div class="panel panel-default">
                                 ...
                                 <div class="col-md-3">
                                  ...
                                  <div class="col-md-3">                                       
                                       <h3 style="color:#0616BC;">Dr. Usha Rani</h3>
                                            <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                                              <div class="panel panel-default">
                            ...
                            <div class="col-md-12" style="">
                                 ...
                                 <div class="col-md-3">
                                  ...
                                  <div class="col-md-3">
                                      <h3 style="color:#0616BC;">Dr.John</h3>									   
                                            <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                                              <div class="panel panel-default">
                                                <div class="panel-heading" role="tab" id="headingOne">
                                                  <h4 class="panel-title">
